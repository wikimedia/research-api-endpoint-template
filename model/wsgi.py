...
EDIT_TYPES = ['fix grammar', 'fix spelling', 'add outlinks', 'add inlinks', 'add images', 'add categories', 'add comment', 'adjust formatting', 'add references', 'update fact', 'add fact', 'add section', 'add alt-text', 'fill in template', 'add external link', 'add table', 'add template', 'restructure article', 'add interwiki link']

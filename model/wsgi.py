...
EDIT_TYPES = ['fix grammar', 'fix spelling', 'add outlinks', 'add inlinks', 'add images', 'add categories', 'identify issues', 'add references', 'update fact', 'add fact', 'add section', 'translate article', 'add alt-text', 'fill in template', 'add external link', 'add table', 'add template', 'improve lede', 'restructure article', 'improve readability', 'create article', 'revert', 'administrative', 'change redirect', 'add interwiki link']
